...
//usando a variável conexao DAL
    ...
    public TelaUsuario() {
        initComponents();
        //método conector dentro do módulo conexão
    ...
    private void consultar() {
        ...
        try {
            ...
            rs = pst.executeQuery();
            if (rs.next()) {
                //pega os campos de acordo com a posição
                ...
                //as linhas abaixo "limpam os campos na tela se usuário não for encontrado
    ...
    private void adicionar() {
        ...
        try {
            ...
            //converte em String o combobox com toString
    ...
    private void remover(){
        ...
        if(confirma == JOptionPane.YES_NO_OPTION){
            ...
            try {
                ...
                }//as linhas abaixo "limpam os campos na tela quando usuário for removido
                txtUsuId.setText(null);
                txtUsuNome.setText(null);
                txtUsuFone.setText(null);
                txtUsuLogin.setText(null);
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                            .addGap(12, 12, 12)
                                            .addComponent(txtUsuLogin, javax.swing.GroupLayout.PREFERRED_SIZE, 259, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createSequentialGroup()
